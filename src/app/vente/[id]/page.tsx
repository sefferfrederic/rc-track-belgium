...
import { fetchListing, setListingSold, deleteListing } from "@/lib/firebase/listings";
...
export default function ListingDetailPage() {
  ...
  if (loading) return <p className="pt-8 text-center text-track-muted">{t("home_loading")}</p>;
